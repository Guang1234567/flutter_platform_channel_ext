 ...
 */
public interface ExtMethodCodec {
    /**
     ...
     * the current position.
     */
    ByteBuffer encodeSuccessEnvelope(String method, Object result);
     ...
     * the current position.
     */
    ByteBuffer encodeErrorEnvelope(String method, String errorCode, String errorMessage, Object errorDetails);
     ...
     */
    Object decodeEnvelope(String method, ByteBuffer envelope);
}
